...
export_db_macinfolib(db, os.devnull, 0)
export_db_macserial(db, os.devnull, 0)
# Export new models
export_db_macinfolib(db, 'Library/MacInfoLib/AutoGenerated.c', 2012)
export_db_macserial(db, 'macserial/src/modelinfo_autogen.h', 0)
