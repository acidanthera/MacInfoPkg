...
static const char *AppleModelCode[][APPLE_MODEL_CODE_MAX] = {
  ...
  /* MacBookAir7,1  */ {"GFWK", "GFWL", "GFWM", "GFWN", "GFWP", "GKJY", "GKK0", "GL28", "GL2D", "GL2F", "GL2H", "GLCQ", "GMC5", "GMC6", "GMC7", "GMC8", "GMC9", "GNJK", "GNJL"},
  ...
  /* MacBookPro15,2 */ {"JHCC", "JHC8", "JHC9", "JHCD", "JHCF", "JHD2", "JHD3", "JHD4", "JHD5", "KK98", "KK99", "KK9C", "KQ1X", "KQ1Y", "KQ20", "KQ21", "KQ22", "KQ23", "KQ24", "KQ25", "KQ26", "KQ27", "LVDC", "LVDM"},
  /* MacBookPro15,3 */ {"LVCG", "LVCJ", "LVDQ"},
